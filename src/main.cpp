...
#if defined(NDEBUG)
# error "IAMKEY cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x94c70ab9d256e28fffab468864f1d0392ae38e3302d2c33398b0b956f4cd850d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // IAMKEY: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "IAMKEY Signed Message:\n";
...
{
    // IAMKEY: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // IAMKEY: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 15 * 24 * 60 * 60; // IAMKEY: 15 days
static const int64 nTargetSpacing = 10 * 60; // IAMKEY: 10 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // IAMKEY: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // IAMKEY: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x94c70ab9d256e28fffab468864f1d0392ae38e3302d2c33398b0b956f4cd850d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = " IAMKEY done 9th of december 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("042984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1418130796;
        ...
        assert(block.hashMerkleRoot == uint256("0xce7865c33d1906ef9cf25234f21570cfd1220e5bf0a5a67add3f976204784c8a"));
...
unsigned char pchMessageStart[4] = { 0xd3, 0xc2, 0xd3, 0xbc }; // IAMKEY: increase each by adding 2 to bitcoin's value.
